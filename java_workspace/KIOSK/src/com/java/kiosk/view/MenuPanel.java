...
public class MenuPanel extends JPanel{
	...
	ArrayList<Menu> list =  Cafeteria.menuList;
	...
	public MenuPanel(JFrame f, int w, int h) {
		...
		mPanel.setBorder(new TitledBorder(
				new LineBorder(Color.black,2),"메뉴"));	//패널 경계선 설정
		
		//메뉴값 수동 입력
		c.setMenuBtn();
		
//		mPanel.setLayout(new FlowLayout(FlowLayout.LEFT, 13, 13));		//flowlayout으로 왼쪽부터 정력, 10픽셀씩 띄움
