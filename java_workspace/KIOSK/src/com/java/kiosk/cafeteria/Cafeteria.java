...
public class Cafeteria {
	...
	public static ArrayList<SalesMenu> salesList = new ArrayList<>();
	...
	public void menuAdd(){
		menuList.add(new Menu("비빔밥",100,6000));
		menuList.add(new Menu("라면",300,3000));
		menuList.add(new Menu("컵밥",100,4000));
		menuList.add(new Menu("제육볶음",100,4000));
		menuList.add(new Menu("김치찌개",100,5000));		
	}
